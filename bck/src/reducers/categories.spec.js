...
describe('categories reducer', () => {
  ...
  //     .toEqual({ 0:{invalidated:false, items:{1:true, 2:true}}, 1:{invalidated:false, items:{3:true, 4:true, 5:true}} })
  // });
  //
  ...
  //
  //   expect(nextState.get('categoriesByGroupId').toJSON())
  //     .toEqual({ 0:{invalidated:false, items:{1:true, 2:true}}, 1:{invalidated:false, items:{3:true, 5:true, 6:true}} })
  // });
  //
  ...
  //
  //   expect(nextState.get('categoriesByGroupId').toJSON())
  //     .toEqual({ 0:{invalidated: false, items: {1:true, 2:true}}, 1:{invalidated: false, items: {3:true, 4:true}} })
  //
  // });
