...
class CategoryTreeMenuNode extends Component {
  ...
  render() {
          ...
          <fieldset>
            ...
            <div className="pure-button-group" role="group" aria-label="Buttons...">
              <Button
                title="Cancel"
                type="cancel"
                componentClass="button-small button-warning"
              >
                <Icon icon="fa-undo" />
              </Button>
              <Button
                title="Add Subcategory"
                componentClass="button-small button-success"
              >
                <Icon icon="fa-plus" />
              </Button>
              <Button
                title="Save changes"
                type="submit"
                componentClass="button-small button-primary"
              >
                <Icon icon="fa-check" />
              </Button>
            </div>
      ...
      const roItemUi = (
            <Link
              ...
              { toggleEditFn &&
                ...
                <Button onClick={ (e) => { e.preventDefault(); toggleEditFn(id)} } componentClass="button-xsmall" aria-label="Edit">
    ...
    return (
      <li className={classnames("pure-menu-item", {"current": this.props.currentPathIds.includes(this.props.id)})}>
        {
          enableEdit ?
            editItemUi :
            roItemUi
