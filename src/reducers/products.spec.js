...
describe('products reducer', () => {
  ...
  //     {
  //       1:{prods, _invalidated:false}
  //     }
  //   )
  //   expect(nextState.get('productsByCategoryId').toJSON()).toEqual(
  //     {
  //       0:{invalidated:false, items:{1:true}}
  //     }
  //   )
  // });
  ...
  //   )
  //   expect(nextState.get('productsByCategoryId').toJSON()).toEqual(
  //     { 0:{invalidated:false, items:{1:true, 2:true}}, 1:{invalidated:false, items:{3:true, 4:true, 5:true}} }
  //   )
  // });
  //
  ...
  //   const expectedProductByCategoryIds = fromJS({ 0:{invalidated:false, items:{1:true, 2:true}}, 1:{invalidated:false, items:{3:true, 5:true, 6:true}} })
  //
  ...
  //
  //   expect(nextState.get('productsById').toJSON())
  //     .toEqual(initState.get('productsById').delete(deleteId).toJSON())
  //
  //   expect(nextState.get('productsByCategoryId').toJSON())
  //     .toEqual(initState.get('productsByCategoryId')
  //       .deleteIn([productTree[deleteIdx].category_id, 'items', deleteId]).toJSON())
  //
  // });
